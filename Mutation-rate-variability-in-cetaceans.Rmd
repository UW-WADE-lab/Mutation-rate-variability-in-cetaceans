...
bottom <- ggplot(data=whole_mrate_graph, aes(x=infraorder, y=rate)) +
  geom_violin() +
  labs(x="Infraorder", y="Mutations/site/generation") +
  theme_light() +
  theme(text = element_text(size = 16)) +
  theme(plot.margin = unit(c(10,30,0,0), 'pt'), axis.title.y = element_text(margin = margin(t=0,r=12,b=0,l=5)),
        axis.title.x = element_text(margin = margin(t=12,r=0,b=5,l=0)), legend_position = "none") +
...
bottom <- ggplot(data=mult_refs_graph, aes(x=reference, y=rate, fill = ref_dist)) +
  geom_violin() +
  labs(x="Reference genome", y="Mutations/site/generation") +
