...
bottom <- ggplot(data=whole_mrate_graph, aes(x=infraorder, y=rate, fill=infraorder, color = infraorder, alpha = 0.3)) +
  geom_violin() +
...
bottom <- mult_refs_graph %>% 
  ...
  ggplot(aes(x=reference, y=rate, fill = ref_dist, color = ref_dist, alpha = 0.3)) +
  geom_violin() +
